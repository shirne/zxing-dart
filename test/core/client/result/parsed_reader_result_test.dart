...
void main() {
  ...
  test('testBookmarkType', () {
    doTestResult(
        "MEBKM:URL:google.com;;", "http://google.com", ParsedResultType.URI);
    doTestResult("MEBKM:URL:google.com;TITLE:Google;;",
        "Google\nhttp://google.com", ParsedResultType.URI);
    doTestResult("MEBKM:TITLE:Google;URL:google.com;;",
        "Google\nhttp://google.com", ParsedResultType.URI);
    doTestResult("MEBKM:URL:http://google.com;;", "http://google.com",
        ParsedResultType.URI);
    doTestResult("MEBKM:URL:HTTPS://google.com;;", "HTTPS://google.com",
        ParsedResultType.URI);
  });

  test('testURLTOType', () {
    doTestResult(
        "urlto:foo:bar.com", "foo\nhttp://bar.com", ParsedResultType.URI);
    doTestResult(
        "URLTO:foo:bar.com", "foo\nhttp://bar.com", ParsedResultType.URI);
    doTestResult("URLTO::bar.com", "http://bar.com", ParsedResultType.URI);
    doTestResult(
        "URLTO::http://bar.com", "http://bar.com", ParsedResultType.URI);
  });

  test('testEmailType', () {
    doTestResult("MATMSG:TO:srowen@example.org;;", "srowen@example.org",
        ParsedResultType.EMAIL_ADDRESS);
    doTestResult("MATMSG:TO:srowen@example.org;SUB:Stuff;;",
  ...
  test('testEmailAddressType', () {
    doTestResult("srowen@example.org", "srowen@example.org",
        ParsedResultType.EMAIL_ADDRESS);
    doTestResult("mailto:srowen@example.org", "srowen@example.org",
        ParsedResultType.EMAIL_ADDRESS);
    doTestResult("MAILTO:srowen@example.org", "srowen@example.org",
        ParsedResultType.EMAIL_ADDRESS);
    doTestResult(
  ...
  test('testAddressBookType', () {
    doTestResult(
        "MECARD:N:Sean Owen;;", "Sean Owen", ParsedResultType.ADDRESS_BOOK);
    doTestResult("MECARD:TEL:+12125551212;N:Sean Owen;;",
    ...
    doTestResult(
        ...
        "Sean Owen\nsrowen@example.org\ngoogle.com\nZXing Team",
        ParsedResultType.ADDRESS_BOOK);
    doTestResult("N:Sean Owen;TEL:+12125551212;;",
        "N:Sean Owen;TEL:+12125551212;;", ParsedResultType.TEXT);
  });
  ...
  test('testUPCA', () {
    doTestResult("123456789012", "123456789012", ParsedResultType.PRODUCT,
        BarcodeFormat.UPC_A);
    doTestResult("1234567890123", "1234567890123", ParsedResultType.PRODUCT,
        BarcodeFormat.UPC_A);
  ...
  test('testUPCE', () {
    doTestResult(
        "01234565", "01234565", ParsedResultType.PRODUCT, BarcodeFormat.UPC_E);
  });

  test('testEAN', () {
    doTestResult(
        "00393157", "00393157", ParsedResultType.PRODUCT, BarcodeFormat.EAN_8);
    doTestResult("00393158", "00393158", ParsedResultType.TEXT);
    doTestResult("5051140178499", "5051140178499", ParsedResultType.PRODUCT,
        BarcodeFormat.EAN_13);
    doTestResult("5051140178490", "5051140178490", ParsedResultType.TEXT);
  });

  test('testISBN', () {
    doTestResult("9784567890123", "9784567890123", ParsedResultType.ISBN,
        BarcodeFormat.EAN_13);
    doTestResult("9794567890123", "9794567890123", ParsedResultType.ISBN,
        BarcodeFormat.EAN_13);
  ...
  test('testURI', () {
    doTestResult(
        "http://google.com", "http://google.com", ParsedResultType.URI);
    doTestResult("google.com", "http://google.com", ParsedResultType.URI);
    doTestResult(
        "https://google.com", "https://google.com", ParsedResultType.URI);
    doTestResult(
        "HTTP://google.com", "HTTP://google.com", ParsedResultType.URI);
    doTestResult("http://google.com/foobar", "http://google.com/foobar",
        ParsedResultType.URI);
    doTestResult("https://google.com:443/foobar",
        "https://google.com:443/foobar", ParsedResultType.URI);
    doTestResult(
        "google.com:443", "http://google.com:443", ParsedResultType.URI);
    doTestResult(
        "google.com:443/", "http://google.com:443/", ParsedResultType.URI);
    doTestResult("google.com:443/foobar", "http://google.com:443/foobar",
        ParsedResultType.URI);
    ...
    doTestResult("https://google.com:443/foobar",
        "https://google.com:443/foobar", ParsedResultType.URI);
    doTestResult(
        "ftp://google.com/fake", "ftp://google.com/fake", ParsedResultType.URI);
  ...
  test('testGeo', () {
    ...
    doTestResult("geo:80.33,-32.3344,3.35", "80.33, -32.3344, 3.35m",
  ...
  test('testVCard', () {
    ...
    doTestResult("BEGIN:VCARD\r\nN:Owen;Sean\r\nEND:VCARD", "Sean Owen",
        ParsedResultType.ADDRESS_BOOK);
    doTestResult("BEGIN:VCARD\r\nVERSION:2.1\r\nN:Owen;Sean\r\nEND:VCARD",
        "Sean Owen", ParsedResultType.ADDRESS_BOOK);
    doTestResult(
  ...
  test('testSMSTO', () {
    ...
    doTestResult("smsto:+15551212", "+15551212", ParsedResultType.SMS);
    doTestResult(
        "smsto:+15551212:subject", "+15551212\nsubject", ParsedResultType.SMS);
    ...
    doTestResult("smsto:+15551212:Directions: Do this",
