...
void main() {
  ...
  void doTest(String contents, String? description, String? summary,
      String? location, String startString, String? endString,
      [String? organizer,
    ...
    dateEqual(
        endString, calResult.endTimestamp < 0 ? null : calResult.endTimestamp);
