...
void main() {
  ...
  test('testEDIFACTEncodation', () {
    ...
    expect(
        "240 185 134 24 185 134 24 185 134 24 185 134 24 185 134 24 185 134 24" " 124 47 235 125 240" //<-- this is the temporary unlatch
            +
  ...
  test('testBase256Encodation', () {
    ...
    expect(
        "231 55 108 59 226 126 1 104 99 10 161 167 185 142 164 186 208" " 220 142 164 186 208 58 129 59 209 104 254 150 45",
        visualized);
