...
void main(){
  ...
  grayImage(String srcName) async{
    Directory base = AbstractBlackBoxTestCase.buildTestBase("test/resources/blackbox/partial");
  ...
  test('p11Test', (){
    Result? result;
    var row = BitArray.test(Int32List.fromList([0, 0, 0, 0, 0, 0, 0, 0, -33570816, 118, 0, 0, 946064924, -2026257522, 955253639, 124828, 0, 0, 0, 0]), 640);
    try {
      result =
