...
void main(){
  ...
  AbstractBlackBoxTestCase testCase = AbstractBlackBoxTestCase("src/test/resources/blackbox/qrcode-5", new MultiFormatReader(), BarcodeFormat.QR_CODE);
  test('QRCodeBlackBox5TestCase', () {
    testCase.addTest(19, 19, 0.0);
    testCase.addTest(19, 19, 90.0);
    testCase.addTest(19, 19, 180.0);
    testCase.addTest(19, 19, 270.0);
  });
