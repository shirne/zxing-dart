...
abstract class QRCodeStyle{
  ...
  Future<BufferImage?> blackBlock(int size, {Color blackColor = const Color(0xff000000), Color whiteColor = const Color(0xffffffff)});

  Future<BufferImage?> whiteBlock(int size, {Color blackColor = const Color(0xff000000), Color whiteColor = const Color(0xffffffff)}) async => null;
...
class NormalQRCodeStyle extends QRCodeStyle{
  ...
  @override
  Future<BufferImage?> blackBlock(int size, {Color blackColor = const Color(0xff000000), Color whiteColor = const Color(0xffffffff)}) async {
    BufferImage image = BufferImage(size, size);
    image.drawRect(Rect.fromLTWH(0, 0, size.toDouble(), size.toDouble()), blackColor);
...
class RRectQRCodeStyle extends QRCodeStyle{
  ...
  Future<BufferImage?> blackBlock(int size, {Color blackColor = const Color(0xff000000), Color whiteColor = const Color(0xffffffff)}) async {
    ...
    await image.drawPath(
      Path()..addRRect(RRect.fromLTRBR(0, 0, size.toDouble(), size.toDouble(), Radius.circular(size * 0.2))),
      blackColor,
    );
...
class RRectOutQRCodeStyle extends QRCodeStyle{
  ...
  Future<BufferImage?> whiteBlock(int size, {Color blackColor = const Color(0xff000000), Color whiteColor = const Color(0xffffffff)}) async {
    BufferImage image = BufferImage(size, size);
    image.drawRect(Rect.fromLTWH(0, 0, size.toDouble(), size.toDouble()), blackColor);
    await image.drawPath(
      Path()..addRRect(RRect.fromLTRBR(0, 0, size.toDouble(), size.toDouble(), Radius.circular(size * 0.2))),
