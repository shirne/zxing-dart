...
class PDF417ErrorCorrection {
  ...
  static const List<List<int>> _ecCoefficients = [
    [27, 917], //
    [522, 568, 723, 809], //
    [237, 308, 436, 284, 646, 653, 428, 379], //
    [
      274, 562, 232, 755, 599, 524, 801, 132, 295, //
      116, 442, 428, 295, 42, 176, 65
    ], //
    [
  ...
  static String generateErrorCorrection(
    ...
    for (int i = 0; i < sld; i++) {
      ...
      int t3;
      for (int j = k - 1; j >= 1; j--) {
        t2 = (t1 * _ecCoefficients[errorCorrectionLevel][j]) % 929;
        t3 = 929 - t2;
        e[j] = ((e[j - 1] + t3) % 929);
      }
      t2 = (t1 * _ecCoefficients[errorCorrectionLevel][0]) % 929;
      t3 = 929 - t2;
      e[0] = (t3 % 929);
    }
